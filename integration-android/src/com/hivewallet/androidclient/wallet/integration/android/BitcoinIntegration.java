...
package com.hivewallet.androidclient.wallet.integration.android;
...
public final class BitcoinIntegration
{
	...
	private static void redirectToDownload(final Context context)
	{
		...
		final Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.hivewallet.androidclient.wallet"));
